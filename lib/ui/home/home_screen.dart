        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: [
            BottomNavigationBarItem(
                ...
                icon: ImageIcon(AssetImage('assets/images/quran_ic.png')), label:"Quran" ),
            BottomNavigationBarItem(
                backgroundColor: Color(0xFFB7935F),
                icon: ImageIcon(AssetImage('assets/images/hadeth_ic.png')), label:"Hadeth" ),
            BottomNavigationBarItem(
                backgroundColor: Color(0xFFB7935F),
                icon: ImageIcon(AssetImage('assets/images/sebha_ic.png')), label:"Tasbeh" ),
            BottomNavigationBarItem(
                backgroundColor: Color(0xFFB7935F),
                icon: ImageIcon(AssetImage('assets/images/radio_ic.png')),label: "Radio"),
          ],
        ),
